...
namespace Bibliotech.Base
{
    ...
    {
        private static string _chave = "WZ2H9APJGA4QYXXG", _vetorInicializacao = "RCPYKWT81DOJNW7Y";
        ...
        public static string Decriptar(string textoEncriptado)
        {
            ...
            using (Rijndael algoritmo = CriarInstanciaRijndael(_chave, _vetorInicializacao))
            {
